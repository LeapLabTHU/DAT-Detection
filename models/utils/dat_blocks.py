...
class DAttentionBaseline(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("|dx|_mean", offset[..., 1].abs().mean())
        # print("|dy|_mean", offset[..., 0].abs().mean())
        ...
        return y, pos.reshape(B, self.n_groups, Hk, Wk, 2), einops.rearrange(attn, '(b h) (m n) (p q) -> b h m n p q', b=B, h=self.n_heads, m=H, n=W, p=Hk, q=Wk)
